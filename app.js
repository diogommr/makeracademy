      ...
      <section class="row header mb-5 ">
        ...
        <div class="col col-md-8">
          <div class="event card card-body event-workshop">
            ...
            <p>Bilhete: 15€</p>
            <p>Duração: 2h a 3h</p>
            <a href="#" target="_blank" class="btn btn-primary event-cta " @click="workshopEnrollment('Introdução à Eletrónica e à Computação Física')">Inscrições disponíveis em breve</a>
